...
import logo from '../assets/TINYLINKS.png';
    ...
    <div className='w-screen h-[80px] z-10 bg-white fixed drop-shadow-lg'>
      <div className='flex justify-between px-2  items-center w-full h-full'>
        <div className='flex items-center'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl'><img className='w-48 p-1' src={logo} alt="/" /></h1>
          <ul className='hidden md:flex'>
            <li><Link to="home" smooth={true} duration={500}>Home</Link></li>
            <li><Link to="linkshort" smooth={true} offset={-200} duration={500}>TinyLink</Link></li>
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-white w-full px-8'}>
        ...
        <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to="linkshort" smooth={true} offset={-50} duration={500}>TinyLink</Link></li>
